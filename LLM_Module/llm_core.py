...
class HighLevelPlanner:
    ...
    def load_prompt(self) -> dict[str, str]:
        ...
        from Excu_Module.skill_registry import get_highlevel_prompt_path
        registry_path = get_highlevel_prompt_path()
    ...
    def plan_tasks(
        ...
        try:
            from Excu_Module.skill_registry import try_rule_planners
            rule_based = try_rule_planners(user_input, scene_facts, object_facts)
